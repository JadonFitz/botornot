...
const characters: Character[] = [
  ...
  },
  {
    ...
    role: 'The Host',
    cast: 'Chris Moss',
    text: 'The magnetic host of BOT OR NOT. Charming on camera, he controls the flow of the game with subtle precision, balancing entertainment and manipulation. Behind the smile, Declan knows how to push buttons, spark rivalries, and heighten drama, making him both a guide and a subtle threat.',
  },
  {
    name: 'Blair',
